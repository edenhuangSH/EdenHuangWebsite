...
const links = [
  {
    name: "LinkedIn",
    handle: "eden-huang",
    url: "https://www.linkedin.com/in/eden-huang/",
  ...
  },
  {
    name: "GitHub",
    handle: "edenhuangSH",
    url: "https://github.com/edenhuangSH",
  ...
  },
  {
    name: "Instagram",
    handle: "edenhuangmn",
    url: "https://www.instagram.com/edenhuangmn/",
    description: "Photos and moments from everyday life.",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          ...
          >
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-stone-300 group-hover:translate-x-0.5 transition-transform duration-200">
                  ↗
                </span>
              </div>
